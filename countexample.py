...
input_video =  "./input_images_and_videos/lowcut2.mp4" #  "./input_images_and_videos/The Dancing Traffic Light Manikin by smart.mp4" #"./input_images_and_videos/videoPasto2.mov" #"./input_images_and_videos/pedestrian_survaillance.mp4" #"./input_images_and_videos/videoPasto2.mov"

#if you want to use defaukt model 
#detection_graph, category_index = backbone.set_model('saved_model')

#Name of the directory containing the object detection module we're using
MODEL_NAME = 'inference_graph100image'
...
object_counting_api.custom_counting(input_video, detection_graph, category_index, is_color_recognition_enabled, targeted_objects, fps, width,height,roi)